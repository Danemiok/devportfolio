...
export default function Navigation({ activeSection, isDarkMode, onToggleTheme }: NavigationProps) {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-slate-200 dark:border-slate-800 bg-background-light/80 dark:bg-background-dark/80">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <a
            href="#resume"
            className="hidden sm:inline-flex bg-primary hover:bg-primary/90 text-white px-4 py-2 rounded-lg text-xs font-bold uppercase tracking-wider transition-all"
          >
            Resume
          </a>
          <button
            ...
            className="inline-flex md:hidden items-center justify-center p-2 rounded-lg bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-primary transition-all"
      ...
      <div
        ...
        className={`md:hidden border-t border-slate-200 dark:border-slate-800 bg-background-light/95 dark:bg-background-dark/95 overflow-hidden transition-all duration-300 ${
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex flex-col gap-2">
          ...
          <a
            href="#resume"
            onClick={closeMenu}
            className="mt-2 inline-flex justify-center bg-primary hover:bg-primary/90 text-white px-4 py-3 rounded-lg text-xs font-bold uppercase tracking-wider transition-all"
          >
            Resume
          </a>
        </div>
